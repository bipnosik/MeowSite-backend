...
Generated by 'django-admisdffdsfdn startproject' using Django 5.1.6.

For more information on this file, see
https://docs.djangoproject.com/en/5.1/topics/settings/

For the full list of asdassdaddsasdsettings and their values, see
...
# CORS (если фронтенд работает на другом домене, напdример, localhost:3000)
